...
Scene4::Scene4(Snippets::Camera* cam)
{
	display_text = "Scene 4: Press 'p' to create rain with torbellino.";
    _cam = cam;
...
void Scene4::enter()
{
    ...
    _particleSystems.front()->createTorbellino(Vector3(0, 0, 0), 50.0f, 10.0f);
